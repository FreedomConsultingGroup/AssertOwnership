...
namespace FCG.AssertOwnership
{
    public class ChangeOwnerHandler : AOHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            JObject response = helper.StringToJson(helper.GetRequest(Global.PortalUrl + "/sharing/rest/content/users/" + itemInfo["owner"] + "/" + itemInfo["ownerFolder"] + "/items/" + itemID + "/reassign",
